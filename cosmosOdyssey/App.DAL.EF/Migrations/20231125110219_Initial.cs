    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FromLocations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToLocations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousRefreshTokenExpirationDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RouteInfos_FromLocations_FromLocationId",
                        column: x => x.FromLocationId,
                        principalTable: "FromLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RouteInfos_ToLocations_ToLocationId",
                        column: x => x.ToLocationId,
                        principalTable: "ToLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteInfos_FromLocationId",
                table: "RouteInfos",
                column: "FromLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_RouteInfos_ToLocationId",
                table: "RouteInfos",
                column: "ToLocationId");
        }
